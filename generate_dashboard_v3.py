...
def public_strength(r):
 out={}
 for k,v in r.items():out[k]=round(v,3) if isinstance(v,(int,float)) else v
 return out
strength_public={str(t):{'team':teams[t],**public_strength(r)} for t,r in ratings.items()}
