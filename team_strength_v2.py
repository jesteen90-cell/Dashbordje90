...
def _early_cap(v,evidence):
 """Prevent one/two matches from creating extreme ratings.
 Cap widens smoothly as evidence accumulates.
 """
...
def build_strength(fixtures,teams,decay=.88,prior_matches=5.0,league_goal_rate=1.45):
 ...
 for tid in teams:
  ...
  # Stronger shrink than before when legacy FPL prior is unavailable.
