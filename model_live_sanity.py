...
def pipeline_sanity():
 ...
 assert 'first=d.action_package_selection?.selected||{}' in budget_ui and 'bestMove=first' in budget_ui and "d.current_transfer_state?.free_transfers_remaining" in budget_ui and "d.deadline_lock?.verdict==='UNLOCKED / GO'" in budget_ui
